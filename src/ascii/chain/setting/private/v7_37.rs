//! Settings in firmware version 7.37.
...
define_settings! {
    ...
    /// The type of the [`brake.mode`](https://www.zaber.com/protocol-manual#topic_setting_brake_mode) setting.
    pub struct BrakeMode: Setting<Type = u8, Name = "brake.mode">, AxisScope;
    /// The type of the [`brake.state`](https://www.zaber.com/protocol-manual#topic_setting_brake_state) setting.
    ...
    /// The type of the [`cloop.servo.effort`](https://www.zaber.com/protocol-manual#topic_setting_cloop_servo_effort) setting.
    ...
    /// The type of the [`driver.bipolar`](https://www.zaber.com/protocol-manual#topic_setting_driver_bipolar) setting.
    pub struct DriverBipolar: Setting<Type = bool, Name = "driver.bipolar">, AxisScope;
    /// The type of the [`driver.current.continuous`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_continuous) setting.
    pub struct DriverCurrentContinuous: Setting<Type = u32, Name = "driver.current.continuous">, AxisScope;
    /// The type of the [`driver.current.continuous.max`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_continuous_max) setting.
    ...
    /// The type of the [`driver.current.inject.noise.amplitude`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_inject_noise_amplitude) setting.
    ...
    /// The type of the [`driver.current.overdrive`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_overdrive) setting.
    pub struct DriverCurrentOverdrive: Setting<Type = u32, Name = "driver.current.overdrive">, AxisScope;
    /// The type of the [`driver.current.overdrive.duration`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_overdrive_duration) setting.
    pub struct DriverCurrentOverdriveDuration: Setting<Type = u32, Name = "driver.current.overdrive.duration">, AxisScope;
    /// The type of the [`driver.current.overdrive.max`](https://www.zaber.com/protocol-manual#topic_setting_driver_current_overdrive_max) setting.
    ...
    /// The type of the [`driver.enable.mode`](https://www.zaber.com/protocol-manual#topic_setting_driver_enable_mode) setting.
    ...
    /// The type of the [`driver.i2t.measured`](https://www.zaber.com/protocol-manual#topic_setting_driver_i2t_measured) setting.
    pub struct DriverI2tMeasured: Setting<Type = f32, Name = "driver.i2t.measured">, AxisScope;
    /// The type of the [`driver.overdrive.state`](https://www.zaber.com/protocol-manual#topic_setting_driver_overdrive_state) setting.
    ...
    /// The type of the [`encoder.vel`](https://www.zaber.com/protocol-manual#topic_setting_encoder_vel) setting.
    ...
    /// The type of the [`get.settings.max`](https://www.zaber.com/protocol-manual#topic_setting_get_settings_max) setting.
    ...
    /// The type of the [`motor.current.continuous.max`](https://www.zaber.com/protocol-manual#topic_setting_motor_current_continuous_max) setting.
    ...
    /// The type of the [`motor.current.overdrive.duration`](https://www.zaber.com/protocol-manual#topic_setting_motor_current_overdrive_duration) setting.
    pub struct MotorCurrentOverdriveDuration: Setting<Type = u32, Name = "motor.current.overdrive.duration">, AxisScope;
    /// The type of the [`motor.current.overdrive.max`](https://www.zaber.com/protocol-manual#topic_setting_motor_current_overdrive_max) setting.
    pub struct MotorCurrentOverdriveMax: Setting<Type = u32, Name = "motor.current.overdrive.max">, AxisScope;
    /// The type of the [`motor.i2t.measured`](https://www.zaber.com/protocol-manual#topic_setting_motor_i2t_measured) setting.
    ...
    /// The type of the [`process.control.dir`](https://www.zaber.com/protocol-manual#topic_setting_process_control_dir) setting.
    pub struct ProcessControlDir: Setting<Type = bool, Name = "process.control.dir">, AxisScope;
    /// The type of the [`process.control.hysteresis.temperature`](https://www.zaber.com/protocol-manual#topic_setting_process_control_hysteresis_temperature) setting.
    pub struct ProcessControlHysteresisTemperature: Setting<Type = f32, Name = "process.control.hysteresis.temperature">, AxisScope;
    /// The type of the [`process.control.hysteresis.voltage`](https://www.zaber.com/protocol-manual#topic_setting_process_control_hysteresis_voltage) setting.
    pub struct ProcessControlHysteresisVoltage: Setting<Type = f32, Name = "process.control.hysteresis.voltage">, AxisScope;
    /// The type of the [`process.control.mode`](https://www.zaber.com/protocol-manual#topic_setting_process_control_mode) setting.
    pub struct ProcessControlMode: Setting<Type = u8, Name = "process.control.mode">, AxisScope;
    /// The type of the [`process.control.setpoint.temperature`](https://www.zaber.com/protocol-manual#topic_setting_process_control_setpoint_temperature) setting.
    pub struct ProcessControlSetpointTemperature: Setting<Type = f32, Name = "process.control.setpoint.temperature">, AxisScope;
    /// The type of the [`process.control.setpoint.temperature.filtered`](https://www.zaber.com/protocol-manual#topic_setting_process_control_setpoint_temperature_filtered) setting.
    ...
    /// The type of the [`process.control.setpoint.tf`](https://www.zaber.com/protocol-manual#topic_setting_process_control_setpoint_tf) setting.
    pub struct ProcessControlSetpointTf: Setting<Type = f32, Name = "process.control.setpoint.tf">, AxisScope;
    /// The type of the [`process.control.setpoint.voltage`](https://www.zaber.com/protocol-manual#topic_setting_process_control_setpoint_voltage) setting.
    pub struct ProcessControlSetpointVoltage: Setting<Type = f32, Name = "process.control.setpoint.voltage">, AxisScope;
    /// The type of the [`process.control.setpoint.voltage.filtered`](https://www.zaber.com/protocol-manual#topic_setting_process_control_setpoint_voltage_filtered) setting.
    ...
    /// The type of the [`process.control.source`](https://www.zaber.com/protocol-manual#topic_setting_process_control_source) setting.
    pub struct ProcessControlSource: Setting<Type = u8, Name = "process.control.source">, AxisScope;
    /// The type of the [`process.control.voltage.max`](https://www.zaber.com/protocol-manual#topic_setting_process_control_voltage_max) setting.
    pub struct ProcessControlVoltageMax: Setting<Type = f32, Name = "process.control.voltage.max">, AxisScope;
    /// The type of the [`process.control.voltage.min`](https://www.zaber.com/protocol-manual#topic_setting_process_control_voltage_min) setting.
    pub struct ProcessControlVoltageMin: Setting<Type = f32, Name = "process.control.voltage.min">, AxisScope;
    /// The type of the [`process.current`](https://www.zaber.com/protocol-manual#topic_setting_process_current) setting.
    pub struct ProcessCurrent: Setting<Type = f32, Name = "process.current">, AxisScope;
    /// The type of the [`process.current.max`](https://www.zaber.com/protocol-manual#topic_setting_process_current_max) setting.
    pub struct ProcessCurrentMax: Setting<Type = f32, Name = "process.current.max">, AxisScope;
    /// The type of the [`process.pid.kd`](https://www.zaber.com/protocol-manual#topic_setting_process_pid_kd) setting.
    pub struct ProcessPidKd: Setting<Type = f64, Name = "process.pid.kd">, AxisScope;
    /// The type of the [`process.pid.ki`](https://www.zaber.com/protocol-manual#topic_setting_process_pid_ki) setting.
    pub struct ProcessPidKi: Setting<Type = f64, Name = "process.pid.ki">, AxisScope;
    /// The type of the [`process.pid.kp`](https://www.zaber.com/protocol-manual#topic_setting_process_pid_kp) setting.
    pub struct ProcessPidKp: Setting<Type = f64, Name = "process.pid.kp">, AxisScope;
    /// The type of the [`process.pid.offset`](https://www.zaber.com/protocol-manual#topic_setting_process_pid_offset) setting.
    pub struct ProcessPidOffset: Setting<Type = f32, Name = "process.pid.offset">, AxisScope;
    /// The type of the [`process.startup.mode`](https://www.zaber.com/protocol-manual#topic_setting_process_startup_mode) setting.
    pub struct ProcessStartupMode: Setting<Type = bool, Name = "process.startup.mode">, AxisScope;
    /// The type of the [`process.state`](https://www.zaber.com/protocol-manual#topic_setting_process_state) setting.
    pub struct ProcessState: Setting<Type = bool, Name = "process.state">, AxisScope;
    /// The type of the [`process.voltage`](https://www.zaber.com/protocol-manual#topic_setting_process_voltage) setting.
    pub struct ProcessVoltage: Setting<Type = f32, Name = "process.voltage">, AxisScope;
    /// The type of the [`process.voltage.on`](https://www.zaber.com/protocol-manual#topic_setting_process_voltage_on) setting.
    pub struct ProcessVoltageOn: Setting<Type = f32, Name = "process.voltage.on">, AxisScope;
    /// The type of the [`process.voltage.start`](https://www.zaber.com/protocol-manual#topic_setting_process_voltage_start) setting.
    pub struct ProcessVoltageStart: Setting<Type = f32, Name = "process.voltage.start">, AxisScope;
    /// The type of the [`process.voltage.start.duration`](https://www.zaber.com/protocol-manual#topic_setting_process_voltage_start_duration) setting.
    pub struct ProcessVoltageStartDuration: Setting<Type = f32, Name = "process.voltage.start.duration">, AxisScope;
    /// The type of the [`process.voltage.tf`](https://www.zaber.com/protocol-manual#topic_setting_process_voltage_tf) setting.
    pub struct ProcessVoltageTf: Setting<Type = f32, Name = "process.voltage.tf">, AxisScope;
    /// The type of the [`pvt.numseqs`](https://www.zaber.com/protocol-manual#topic_setting_pvt_numseqs) setting.
    ...
    /// The type of the [`scope.channel.size`](https://www.zaber.com/protocol-manual#topic_setting_scope_channel_size) setting.
    pub struct ScopeChannelSize: Setting<Type = u32, Name = "scope.channel.size">, DeviceScope;
    /// The type of the [`scope.channel.size.max`](https://www.zaber.com/protocol-manual#topic_setting_scope_channel_size_max) setting.
    ...
    /// The type of the [`scope.numchannels`](https://www.zaber.com/protocol-manual#topic_setting_scope_numchannels) setting.
    ...
    /// The type of the [`sensor.temperature.1`](https://www.zaber.com/protocol-manual#topic_setting_sensor_temperature_1) setting.
    pub struct SensorTemperature1: Setting<Type = f32, Name = "sensor.temperature.1">, DeviceScope;
    /// The type of the [`sensor.temperature.2`](https://www.zaber.com/protocol-manual#topic_setting_sensor_temperature_2) setting.
    ...
    /// The type of the [`system.current.max`](https://www.zaber.com/protocol-manual#topic_setting_system_current_max) setting.
    ...
    /// The type of the [`system.uptime`](https://www.zaber.com/protocol-manual#topic_setting_system_uptime) setting.
    ...
    /// The type of the [`vel`](https://www.zaber.com/protocol-manual#topic_setting_vel) setting.
...
define_any_setting! {
/// Any setting available in firmware version 7.37.
pub enum AnySetting {
