//! Settings in firmware version 6.21.
...
define_settings! {
    ...
    /// The type of the [`encoder.counth`](https://www.zaber.com/w/Manuals/ASCII_Protocol_Manual#encoder.counth) setting.
    pub struct EncoderCounth: Setting<Type = i32, Name = "encoder.counth">, AxisScope;
...
define_any_setting! {
/// Any setting available in firmware version 6.21.
pub enum AnySetting {
    ...
    EncoderCount,
    /// The [encoder.counth](https://www.zaber.com/w/Manuals/ASCII_Protocol_Manual#encoder.counth) setting.
    EncoderCounth,
